<template>
  <v-app dark>
    <v-navigation-drawer v-model="drawer" v-if="showNav()" :mini-variant="miniVariant" :clipped="clipped" app class="modern-drawer"
    ...
    <v-app-bar color="white" v-if="true" :clipped-left="clipped" fixed app>
      <div align="start">
        <v-img class="pointer" src="/logo_official.png" height="100" width="150" contain @click="goIndex" />
      </div>
      <v-spacer />
...
.modern-drawer .v-list-item {
  color: #333;
  /* Dark text color */
}

.modern-drawer .v-list-item:hover {
  background-color: #e0e0e0;
  /* Hover background color */
}

.modern-drawer .v-list-item--active {
