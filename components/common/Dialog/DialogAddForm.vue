...
<!-- Description: Global dialog card for add -->
<template>
    <v-dialog v-model="dialog" max-width="500px" persistent>
        <v-card class="dialog-card">
            ...
            <v-card-text>
                <div class="">
                    <component :is="content" @handleInputForm="handleInputForm"></component>
                </div>
            </v-card-text>
            <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn text color="primary" @click="cancelAddDialog">Close</v-btn>
...
<script>
import EventAddForm from '../../events/forms/EventAddForm.vue';
export default {
    props: ["dialog", "feature"],
    data() {
        return {
            content: null,
            input_value: {
