...
<!-- Description: Update form for Event-->
...
<template>
    <v-card class="form-card" outlined>
        ...
        <v-card-text>
            <v-row>
                <v-col cols="12">
                    <v-text-field v-model="data.event_name" @input="emitInput('event_name')"
                        label="Event Name"></v-text-field>
                </v-col>
            </v-row>
            <v-row>
                <v-col cols="12">
                    <v-textarea v-model="data.description" @input="emitInput('description')"
